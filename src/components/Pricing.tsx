...
export default function Pricing() {
  ...
  return (
    <section id="precio" className="py-24 sm:py-32 relative overflow-hidden" ref={ref}>
      ...
      <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="fade-up fade-up-delay-2">
          <div className="bg-bg-card border border-accent/30 rounded-3xl overflow-hidden shadow-xl shadow-accent/5">
            {/* Header */}
            <div className="bg-gradient-to-r from-accent/10 via-accent/5 to-transparent p-8 sm:p-10 border-b border-border">
              <div className="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-6">
                <div>
                  <span className="text-accent font-semibold text-sm">Web Dental Profesional</span>
                  <div className="mt-2 flex items-baseline gap-2">
                    <span className="text-4xl sm:text-5xl font-extrabold text-text-primary">$150.000</span>
            ...
            <div className="px-8 sm:px-10 pb-8 sm:pb-10">
              <a
                ...
                className="block w-full text-center bg-accent hover:bg-accent-light text-white font-bold py-4 rounded-xl transition-all shadow-lg shadow-accent/20 hover:shadow-accent/30 hover:-translate-y-0.5 text-lg"
              >
