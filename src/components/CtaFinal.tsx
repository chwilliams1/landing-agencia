  ...
  return (
    <section className="py-24 sm:py-32 relative overflow-hidden" ref={ref}>
      ...
      <div className="relative max-w-3xl mx-auto px-4 sm:px-6 text-center">
        ...
        <h2 className="fade-up fade-up-delay-1 text-3xl sm:text-4xl lg:text-5xl font-extrabold tracking-tight leading-tight">
          Tu competencia ya tiene web.
          <br />
          <span className="gradient-text">¿Y tú?</span>
        </h2>

        <p className="fade-up fade-up-delay-2 mt-6 text-text-secondary text-lg sm:text-xl max-w-xl mx-auto leading-relaxed">
          Cada día sin web son pacientes que eligen a otro dentista. Conversemos por WhatsApp y en 48 horas tienes tu página lista.
        </p>
        ...
        <div className="fade-up fade-up-delay-3 mt-10">
          <a
            ...
            className="group inline-flex items-center justify-center gap-3 bg-green-500 hover:bg-green-600 text-white px-6 sm:px-10 py-5 rounded-full text-lg sm:text-xl font-bold transition-all shadow-xl shadow-green-500/25 hover:shadow-green-500/40 hover:-translate-y-1"
          >
        ...
        <div className="fade-up fade-up-delay-4 mt-8 flex flex-col sm:flex-row items-center justify-center gap-6 text-sm text-text-muted">
