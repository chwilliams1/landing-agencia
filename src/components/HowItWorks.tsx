...
const steps = [
  {
    ...
    title: "Conversemos",
    description:
      "Nos cuentas sobre tu consulta, tu especialidad y qué necesitas. Sin compromiso.",
    icon: (
  ...
  },
  {
    ...
    description:
      "Creamos un diseño profesional adaptado a tu marca y especialidad dental.",
    icon: (
      <svg className="w-7 h-7" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
  ...
  },
  {
    ...
    description:
      "Publicamos tu página y empiezas a recibir pacientes desde Google y WhatsApp.",
    icon: (
      <svg className="w-7 h-7" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-10 sm:mb-16">
          ...
          <h2 className="fade-up fade-up-delay-1 mt-3 sm:mt-4 text-2xl sm:text-4xl lg:text-5xl font-extrabold tracking-tight">
            ¿Cómo funciona?{" "}
            <span className="gradient-text">Así de simple</span>
          </h2>
        </div>
