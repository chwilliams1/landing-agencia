          ...
          {testimonials.map((t, i) => (
            ...
            >
              ...
              <div className="mt-5 flex items-center gap-3">
                <div className={`w-10 h-10 sm:w-11 sm:h-11 ${t.color} rounded-full flex items-center justify-center text-white font-bold text-sm shrink-0`}>
                  {t.initials}
                </div>
                <div className="min-w-0">
                  <p className="text-sm font-semibold text-text-primary truncate">{t.name}</p>
                  <p className="text-xs sm:text-sm text-text-muted truncate">{t.role}</p>
                </div>
              </div>
            </div>
          ))}
