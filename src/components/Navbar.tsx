  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 flex items-center h-16 sm:h-20">
        ...
        {/* Desktop CTA + Hamburger (mobile) — right side balances logo */}
        <div className="flex items-center justify-end md:w-40 ml-auto md:ml-0">
          <a
            href="/intake"
            className="hidden md:inline-flex items-center gap-2 bg-accent hover:bg-accent-light text-white px-5 py-2 rounded-full text-sm font-bold transition-all shadow-md shadow-accent/20 hover:shadow-accent/30 hover:-translate-y-0.5"
          >
            Quiero mi web
